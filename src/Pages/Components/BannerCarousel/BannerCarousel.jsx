...
const BannerCarousel = () => {
  ...
  return (
    <div className="carousel w-full h-[90vh] relative mb-10" ref={carouselRef}>
        ...
        <>
          <div key={index} className="carousel-item relative w-full">
            ...
            <div className="absolute top-[45%] md:top-1/3 left-16 ">
                <h1 className="text-white text-lg md:text-4xl lg:text-6xl font-inter font-bold">Affordable <br /> Price for <br /> Car Services </h1>
                <p className="text-white text-xs md:text-xl mt-5 font-inter">There are many variations of passages of  available, but <br /> the majority have suffered alteration in some form</p>

                <div className="flex gap-2 mt-5 font-inter">
  <button className="bg-[#FF3811] text-white md:px-3 md:py-1 px-2 py-1">Discover More</button>
  <button className="text-white border border-white md:px-3 md:py-1 px-2 py-1">Latest Project</button>
</div>

            </div>

            <img src={slide.src} className="w-full" />
            <div className="absolute flex justify-end transform right-5 bottom-5 gap-2 ">
              <button
